...
<p align="justify"> I also worked as an AI researcher at MBZUAI Metaverse Lab, collaborating with <a href="https://scholar.google.ca/citations?hl=en&user=VcOjgngAAAAJ&view_op=list_works&sortby=pubdate">Prof. Abdulmotaleb El Saddik</a> and <a href="https://scholar.google.com/citations?user=NFeigSoAAAAJ">Dr. Hao Li</a>. My main research endeavors revolved around the enhancement of 2D classifiers in the domain of Violence Detection. I also led an innovative project, called ScholarFace (more details on that soon).</p>
